...
{
    string s;
    ll current, max, lastDelta;
    cin >> s >> current >> max >> lastDelta;
    current += lastDelta;
    if (max == 0 && current > 0 || max <= 1199 && current > 1199 || max <= 1399 && current > 1399 || 
    max <= 1599 && current > 1599 || max <= 1899 && current > 1899 || max <= 2099 && current > 2099 || 
    max <= 2399 && current > 2399) 
        emblemTheMember(current);
